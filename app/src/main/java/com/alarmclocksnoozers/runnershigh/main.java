  ...
  public class RunnersHighView extends GLSurfaceView implements Runnable {
    ...
    public void cleanup() {
      if (saveButtonImg != null) {
        saveButtonImg.recycle();
      }
      if (blackImg != null) {
        blackImg.recycle();
      }
      if (resetButtonImg != null) {
        resetButtonImg.recycle();
      }
      if (background != null) {
        background.cleanup();
      }
      if (mHighscoreMarkBitmap != null) {
        mHighscoreMarkBitmap.recycle();
      }
      if (level != null) {
        level.cleanup();
      }
    ...
    private void initialize() {
      ...
      resetButton = new Button(Util.getPercentOfScreenWidth(72), height - Util.getPercentOfScreenHeight(18), -2,
          Util.getPercentOfScreenWidth(26), Util.getPercentOfScreenHeight(13));
      ...
      saveButton = new Button(Util.getPercentOfScreenWidth(42), height - Util.getPercentOfScreenHeight(18), -2,
          Util.getPercentOfScreenWidth(26), Util.getPercentOfScreenHeight(13));
      ...
      CounterYourScoreDrawable =
          new RHDrawable(Util.getPercentOfScreenWidth(5), height - Util.getPercentOfScreenHeight(15), 0.9f,
              Util.getPercentOfScreenWidth(27), Util.getPercentOfScreenHeight(10));
      ...
      mCounterGroup =
          new CounterGroup(Util.getPercentOfScreenWidth(14), height - Util.getPercentOfScreenHeight(13.5f), 0.9f,
              Util.getPercentOfScreenWidth(16), Util.getPercentOfScreenHeight(6), 25);
      ...
      mCounterDigit1 =
          new CounterDigit(Util.getPercentOfScreenWidth(19), height - Util.getPercentOfScreenHeight(13.5f), 0.9f,
              Util.getPercentOfScreenWidth(3), Util.getPercentOfScreenHeight(6));
      mCounterDigit1.loadBitmap(CounterFont);
      mCounterGroup.add(mCounterDigit1);

      mCounterDigit2 =
          new CounterDigit(Util.getPercentOfScreenWidth(22), height - Util.getPercentOfScreenHeight(13.5f), 0.9f,
              Util.getPercentOfScreenWidth(3), Util.getPercentOfScreenHeight(6));
      mCounterDigit2.loadBitmap(CounterFont);
      mCounterGroup.add(mCounterDigit2);

      mCounterDigit3 =
          new CounterDigit(Util.getPercentOfScreenWidth(25), height - Util.getPercentOfScreenHeight(13.5f), 0.9f,
              Util.getPercentOfScreenWidth(3), Util.getPercentOfScreenHeight(6));
      mCounterDigit3.loadBitmap(CounterFont);
      mCounterGroup.add(mCounterDigit3);

      mCounterDigit4 =
          new CounterDigit(Util.getPercentOfScreenWidth(28), height - Util.getPercentOfScreenHeight(13.5f), 0.9f,
              Util.getPercentOfScreenWidth(3), Util.getPercentOfScreenHeight(6));
    ...
    @SuppressWarnings ("unused") public void run() {
      ...
      try {
        ...
        try {
          ...
          e.printStackTrace();
          Log.w(Settings.LOG_TAG,
              "seems like you startet the game more" + " than once in a few seconds or canceld the game start");
      ...
      while (isRunning) {
        ...
        player.playerSprite.setFrameUpdateTime(
            (level.baseSpeedMax + level.extraSpeedMax) * 10 - ((level.baseSpeed + level.extraSpeed) * 10) + 60);
        if (player.update()) {
          if (Settings.RHDEBUG) {
        ...
        if (doUpdateCounter) {
          ...
          if (Settings.SHOW_FPS) {
            mCounterGroup.tryToSetCounterTo(mRenderer.fps);
          } else {
